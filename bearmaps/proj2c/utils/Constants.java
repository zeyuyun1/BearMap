...
public class Constants {
    ...
    /** size of map (longitude )*/
    public static final double RangeLon = Math.abs(Constants.ROOT_LRLON-Constants.ROOT_ULLON);
    public static final double RangeLat = Math.abs(Constants.ROOT_LRLAT-Constants.ROOT_ULLAT);
